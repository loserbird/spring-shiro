...
import com.loserbird.model.Role;
import com.loserbird.model.User;
import com.loserbird.realm.UserRealm;
import com.loserbird.service.PermissionService;
import com.loserbird.service.RoleService;
import com.loserbird.service.UserService;
...
public class ShiroTest {
    ...
    public void setUp() {
        ...
        //4、新增用户
        u1 = new User("bingqin", password);
        u2 = new User("junjie", password);
        u3 = new User("zhicheng", password);
        u4 = new User("junye", password);
